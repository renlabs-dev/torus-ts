...
// /**
//  * This file contains ESLint directives to suppress type errors related to API usage.
//  * The API types are not properly exposed but the functions exist at runtime.
//  */
...
//     // @ts-expect-error - API endpoint exists at runtime but is not typed properly
