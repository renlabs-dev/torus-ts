      ...
      {discordId ? (
        <div className="flex items-center gap-3 rounded bg-gray-600/20 p-3">
          ...
          <button
            type="button"
            onClick={() => signOut({ redirect: false })}
            className="ml-auto rounded bg-red-500/80 px-3 py-1 text-sm text-white hover:bg-red-600"
            disabled={isLoading}
          >
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded bg-[#5865F2] p-3 text-white hover:bg-[#4752c4]"
          disabled={isLoading}
        >
          {isLoading ? (
            "Connecting..."
