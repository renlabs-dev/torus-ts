  ...
  return (
    <>
      <div className="z-20 flex min-h-screen w-full animate-fade flex-col items-center justify-center pb-[4.6em]">
        ...
        <Icons.textAsci className="hidden animate-fade-up animate-delay-[1000ms] md:block md:h-[170px] md:w-[650px] 2xl:h-[200px] 2xl:w-[850px]" />
        <h3 className="animate-fade-up text-center text-2xl font-medium leading-9 tracking-tight shadow-sm animate-delay-[1200ms] md:text-[1.450rem] 2xl:text-[1.742rem]">
