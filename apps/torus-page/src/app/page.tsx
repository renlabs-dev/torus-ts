    ...
    <>
      <div className="z-20 flex min-h-screen w-full animate-fade flex-col items-center justify-center pb-[4.6em]">
        ...
        <img
          src="/text-asci.svg"
          alt="Torus"
          className="h-[200px] w-[750px] animate-fade-up animate-delay-[1100ms]"
        />
        <h3 className="animate-fade-up leading-9 tracking-tight shadow-sm animate-delay-[1200ms] md:text-[1.850rem]">
