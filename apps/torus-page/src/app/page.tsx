...
export default function Page(): JSX.Element {
  return (
    <>
      <div
        className="absolute top-0 h-full w-full animate-fade opacity-100 animate-delay-700"
        style={{ overflow: "hidden" }}
      >
        <TorusObject />
      </div>
      <div className="z-20 flex min-h-screen w-full animate-fade flex-col items-center justify-end pb-6">
        ...
        {/* <Image
          ...
          height={1000}
          src="/asci-text.svg"
          className="hidden animate-fade-up animate-delay-[1000ms] md:block md:h-[145px] md:w-[550px] lg:h-[170px] lg:w-[650px] 2xl:h-[200px] 2xl:w-[800px]"
        /> */}
        <Image
          priority
          alt="Torus"
