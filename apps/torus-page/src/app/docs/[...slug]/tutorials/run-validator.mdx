...
You can use the [vote](https://docs.torusx.ai/torusx/client#torusClient.vote) method to set weights. 
...
For a more concrete example, you can take a look at this [sketch of a validator](https://github.com/renlabs-dev/torus-subnet-template/blob/main/src/subnet/validator/validator.py)
