...
#### Step 4: Connect To torus

1. **Adding torus Support**: You can scroll down on your subwallet until you see button *Manage tokens* window saying *Search token* will open up. Search for *com* until you can see the Communa AI icon. Turn on the *C* symbol, now you should be able to see your torus balance.  
2. **Staking Your tokens**: Visit the [explorer](https://explorer.torusai.net/#/accounts), connect your wallet, and follow the [video tutorial](https://www.youtube.com/watch?v=JrQKG7ko14M&t=195s)
