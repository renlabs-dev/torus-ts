...
To install the **torusx** Python package using pip, run:

```sh
pip install torusx
```

Alternatively, to add **torusx** to your Poetry project, use:
...
To install the **torusx** CLI with Nix, execute:
...
**torusX** offers a variety of features for token management and module interaction:
...
The **torusx** CLI is structured as follows:
...
If you have any questions, feel free to ask on the [torusX Discord channel] or
...
Yes, **torusX** is compatible with the **torus** library/CLI. However, there are
important considerations to note. **torusX** verifies the integrity of your
...
[open an issue on GitHub]: https://github.com/renlabs-dev/torusx/issues/new/choose
[torusX Discord channel]: https://go.renlabs-dev.org/torusx-channel
[GitHub discussions page]: https://github.com/renlabs-dev/torusx/discussions
