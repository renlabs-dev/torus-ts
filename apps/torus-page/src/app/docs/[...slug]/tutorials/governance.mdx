...
You can view and vote on proposals on the [Community Proposals](https://governance.torusai.org/) website.
...
Visit the [Community Proposals](https://governance.torusai.org/) website to view the latest proposals submitted by community members. Each proposal contains details about the proposed change, its rationale, and the potential impact on the network.
...
torusX CLI fully supports all governance processes, thy are located under the **network** and **subnet** subcommand.
