...
Managing keys is a fundamental aspect of using the **torusX** CLI. This section provides a comprehensive guide on how to create, retrieve, and manage keys within the system. Whether you're looking to generate a new key, view details of existing keys, or list all keys along with their balances, the following commands will facilitate these operations efficiently.
