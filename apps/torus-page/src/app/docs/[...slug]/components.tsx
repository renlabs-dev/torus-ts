...
const startCardsData = [
  {
    title: "Install",
    description:
      "Set up your torus and wallet to start participating in the network.",
    link: "/docs/installation/setup-torus",
  },
  {
  ...
  },
  {
    ...
    description:
      "Learn the structure of torus AI source code, and how to contribute.",
    link: "https://docs.torusx.ai/torusx",
  },
  {
    title: "Watch Videos",
    description:
      "Watch tutorials and guides on how to operate within the torus AI network.",
...
const basicsCardsData = [
  ...
  },
  {
    ...
    link: "/docs/subspace/torus-blockchain",
  },
];
...
const subnetCardsData = [
  {
    ...
    link: "https://github.com/renlabs-dev/torus-subnet-template",
  },
];
