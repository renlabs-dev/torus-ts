  ...
  describe("TransactionLifecycleDialog", () => {
    ...
    describe("rendering", () => {
      ...
      it("should render dialog title", () => {
        ...
        expect(screen.getByText("Transfer Progress")).toBeInTheDocument();
      });
    ...
    describe("step status messages", () => {
      it("should show message for signing state", () => {
        ...
        expect(screen.getByTestId("transfer-status-message")).toHaveTextContent(
      ...
      it("should show message for confirming state", () => {
        ...
        expect(screen.getByTestId("transfer-status-message")).toHaveTextContent(
          /Transaction submitted!.*Waiting for network confirmation/i,
        );
      });
      ...
      it("should show message for step 1 complete state", () => {
        ...
        expect(screen.getByTestId("transfer-status-message")).toHaveTextContent(
          /First step complete!.*Preparing second transaction/i,
        );
      });
      ...
      it("should show message for step 2 signing state", () => {
        ...
        expect(screen.getByTestId("transfer-status-message")).toHaveTextContent(
          "Please check your wallet and sign the second transaction",
        );
      });
      ...
      it("should show message for step 2 confirming state", () => {
        ...
        expect(screen.getByTestId("transfer-status-message")).toHaveTextContent(
          /Final transaction submitted!.*Almost done/i,
        );
      });
      ...
      it("should show message for complete state", () => {
        ...
        expect(screen.getByTestId("transfer-status-message")).toHaveTextContent(
          /Transfer complete!.*All transactions successful/i,
        );
      });
      ...
      it("should show message for error state", () => {
        ...
        expect(screen.getByTestId("transfer-status-message")).toHaveTextContent(
          /Transaction failed.*Please try again/i,
        );
      });
    });
    ...
    describe("signature warning", () => {
      it("should not show warning if transfer completes quickly", async () => {
        ...
        expect(
          screen.queryByTestId("signature-warning"),
        ).not.toBeInTheDocument();
      });
    });
