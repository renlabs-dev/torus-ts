    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle
          ...
          data-testid="wallet-connector-title"
        >
      ...
      <CardContent className="space-y-4">
        <div
          ...
          data-testid="torus-wallet-section"
        >
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <p className="font-medium" data-testid="torus-wallet-name">
                Torus Wallet
              </p>
              <p
                className="text-muted-foreground text-sm"
        ...
        <div
          className="flex items-center justify-between rounded-lg border p-4"
          data-testid="evm-wallet-section"
        >
          <div className="flex items-center gap-3">
            <div
            ...
            {walletsReady ? (
              ...
              <>
                ...
                <span
                  ...
                  data-testid="connection-status-message"
                >
