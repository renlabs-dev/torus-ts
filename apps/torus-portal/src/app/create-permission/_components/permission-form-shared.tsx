...
interface PermissionFormSharedProps {
...
export function PermissionFormShared({
  form,
  mutation,
  onClose,
  isEdit = false,
  submitButtonText = "Create Permission",
}: PermissionFormSharedProps) {
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Specify the recipient who will receive the emission permission and
              be able to allocate streams.
            </p>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            {allocationType === "Streams" && (
              <div className="space-y-4">
                ...
                {availableStreams.data && availableStreams.data.length > 0 && (
                  <p className="text-sm text-muted-foreground">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-32">
                      ...
                      <FormControl>
                        <Input {...field} placeholder="e.g. 20" type="number" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Set how long this permission remains active (indefinitely or until
        ...
        <div className="flex gap-4 justify-center">
          ...
          <Button
            ...
            className="w-full"
          >
            {mutation.isPending ? "Processing..." : submitButtonText}
          </Button>
        </div>
      </form>
    </Form>
