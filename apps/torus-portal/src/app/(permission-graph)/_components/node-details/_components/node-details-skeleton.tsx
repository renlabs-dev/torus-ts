...
import { Accordion, AccordionItem, AccordionTrigger, AccordionContent } from "@torus-ts/ui/components/accordion";
...
import type {CachedAgentData, CustomGraphData, CustomGraphNode, PermissionDetail, PermissionWithType} from "../../permission-graph-utils";
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <div>
                                ...
                                <div className="text-sm text-gray-300">
                                  {formatDuration(calculateTimeRemaining(details.createdAt, Number(details.duration)))}
                                </div>
                              </div>
                            </div>
