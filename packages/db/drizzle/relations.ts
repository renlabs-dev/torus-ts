...
export const cadreCandidateRelations = relations(
  cadreCandidate,
  ({ many }) => ({
...
export const commentInteractionRelations = relations(
  commentInteraction,
  ({ one }) => ({
    comment: one(comment, {
...
export const computedAgentWeightRelations = relations(
  computedAgentWeight,
  ({ one }) => ({
    agent: one(agent, {
...
export const agentApplicationVoteRelations = relations(
  agentApplicationVote,
  ({ one }) => ({
    cadre: one(cadre, {
...
export const penalizeAgentVotesRelations = relations(
  penalizeAgentVotes,
  ({ one }) => ({
    cadre: one(cadre, {
...
export const userAgentWeightRelations = relations(
  userAgentWeight,
  ({ one }) => ({
    agent: one(agent, {
