...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium backdrop-blur-md transition transition-colors duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        base: "border",
        default:
          "hover:bg-background-purple border border-white/20 bg-[#898989]/5 bg-background text-white hover:border-purple-500 hover:text-purple-500 active:bg-purple-500/40",
        destructive:
