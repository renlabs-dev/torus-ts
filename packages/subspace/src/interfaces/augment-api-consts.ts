...
import type { u8, u16, u32, u64, u128 } from "@polkadot/types-codec";
...
declare module "@polkadot/api-base/types/consts" {
  interface AugmentedConsts<ApiType extends ApiTypes> {
    ...
    governance: {
      ...
      defaultMaxProposalRewardTreasuryAllocation: u128 &
        AugmentedConst<ApiType>;
      defaultProposalCost: u128 & AugmentedConst<ApiType>;
      defaultProposalExpiration: u64 & AugmentedConst<ApiType>;
      defaultProposalRewardInterval: u64 & AugmentedConst<ApiType>;
      defaultProposalRewardTreasuryAllocation: Percent &
        AugmentedConst<ApiType>;
