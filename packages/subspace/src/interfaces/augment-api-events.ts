...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    governance: {
       ...
       **/
      ApplicationCreated: AugmentedEvent<ApiType, [u32]>;
      /**
       * An application has been denied.
       **/
      ApplicationDenied: AugmentedEvent<ApiType, [u32]>;
      /**
       ...
       **/
      WhitelistAdded: AugmentedEvent<ApiType, [AccountId32]>;
      /**
       * An agent account has been removed from the whitelist.
       **/
      WhitelistRemoved: AugmentedEvent<ApiType, [AccountId32]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    system: {
       ...
       **/
      TaskCompleted: AugmentedEvent<ApiType, [task: TorusRuntimeRuntimeTask], { task: TorusRuntimeRuntimeTask }>;
      /**
       * A [`Task`] failed during execution.
       **/
      TaskFailed: AugmentedEvent<ApiType, [task: TorusRuntimeRuntimeTask, err: SpRuntimeDispatchError], { task: TorusRuntimeRuntimeTask, err: SpRuntimeDispatchError }>;
      /**
       * A [`Task`] has started executing
       **/
      TaskStarted: AugmentedEvent<ApiType, [task: TorusRuntimeRuntimeTask], { task: TorusRuntimeRuntimeTask }>;
      /**
