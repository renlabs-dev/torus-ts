...
declare module "@polkadot/api-base/types/submittable" {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    emission0: {
      delegateWeightControl: AugmentedSubmittable<
        (
          target: AccountId32 | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32]
      >;
      regainWeightControl: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >;
    ...
    governance: {
      acceptApplication: AugmentedSubmittable<
        (
          applicationId: u32 | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [u32]
      >;
      addAllocator: AugmentedSubmittable<
        (
          key: AccountId32 | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32]
      >;
      addCurator: AugmentedSubmittable<
        (
          key: AccountId32 | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32]
      >;
      addDaoTreasuryTransferProposal: AugmentedSubmittable<
        (
          value: u128 | AnyNumber | Uint8Array,
      ...
      >;
      addEmissionProposal: AugmentedSubmittable<
        (
          recyclingPercentage: Percent | AnyNumber | Uint8Array,
          treasuryPercentage: Percent | AnyNumber | Uint8Array,
          data: Bytes | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [Percent, Percent, Bytes]
      >;
      addGlobalCustomProposal: AugmentedSubmittable<
        (
          metadata: Bytes | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [Bytes]
      >;
      addGlobalParamsProposal: AugmentedSubmittable<
        (
          data:
            | PalletGovernanceProposalGlobalParamsData
            | {
                minNameLength?: any;
                maxNameLength?: any;
                maxAllowedAgents?: any;
                maxAllowedWeights?: any;
                minStakePerWeight?: any;
                minWeightControlFee?: any;
                minStakingFee?: any;
                dividendsParticipationWeight?: any;
                proposalCost?: any;
              }
            | string
            | Uint8Array,
        ...
        [PalletGovernanceProposalGlobalParamsData, Bytes]
      >;
      addToWhitelist: AugmentedSubmittable<
        ...
        [AccountId32]
      >;
      denyApplication: AugmentedSubmittable<
        (
          applicationId: u32 | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [u32]
      >;
      disableVoteDelegation: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >;
      enableVoteDelegation: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >;
      penalizeAgent: AugmentedSubmittable<
        (
          agentKey: AccountId32 | string | Uint8Array,
          percentage: u8 | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32, u8]
      >;
      removeAllocator: AugmentedSubmittable<
        (
          key: AccountId32 | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32]
      >;
      removeCurator: AugmentedSubmittable<
        (
          key: AccountId32 | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32]
      ...
      removeFromWhitelist: AugmentedSubmittable<
        ...
        [AccountId32]
      >;
      removeVoteProposal: AugmentedSubmittable<
        (
          proposalId: u64 | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [u64]
      >;
      submitApplication: AugmentedSubmittable<
        (
          agentKey: AccountId32 | string | Uint8Array,
          metadata: Bytes | string | Uint8Array,
          removing: bool | boolean | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32, Bytes, bool]
      >;
    ...
    system: {
      ...
      authorizeUpgradeWithoutChecks: AugmentedSubmittable<
        ...
        [H256]
      >;
      doTask: AugmentedSubmittable<
        (task: TorusRuntimeRuntimeTask | null) => SubmittableExtrinsic<ApiType>,
        [TorusRuntimeRuntimeTask]
      >;
      /**
    ...
    torus0: {
      addStake: AugmentedSubmittable<
        ...
        [AccountId32, u128]
      >;
      registerAgent: AugmentedSubmittable<
        (
          agentKey: AccountId32 | string | Uint8Array,
      ...
      transferStake: AugmentedSubmittable<
        (
          agentKey: AccountId32 | string | Uint8Array,
          newAgentKey: AccountId32 | string | Uint8Array,
          amount: u128 | AnyNumber | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32, AccountId32, u128]
      >;
      unregisterAgent: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >;
      updateAgent: AugmentedSubmittable<
        (
          name: Bytes | string | Uint8Array,
          url: Bytes | string | Uint8Array,
          metadata: Option<Bytes> | null | Uint8Array | Bytes | string,
          stakingFee: Option<Percent> | null | Uint8Array | Percent | AnyNumber,
          weightControlFee:
            | Option<Percent>
            | null
            | Uint8Array
        ...
        [Bytes, Bytes, Option<Bytes>, Option<Percent>, Option<Percent>]
      >;
      /**
       * Generic tx
       **/
