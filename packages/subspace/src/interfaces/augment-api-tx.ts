...
declare module "@polkadot/api-base/types/submittable" {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    emission0: {
      delegateWeightControlExtrinsic: AugmentedSubmittable<
        (
          target: AccountId32 | string | Uint8Array,
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32]
      >;
      regainWeightControlExtrinsic: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >;
      setWeightsExtrinsic: AugmentedSubmittable<
        (
          weights:
    ...
    torus0: {
      ...
      removeStake: AugmentedSubmittable<
        ...
        [AccountId32, u128]
      >;
      transferBalance: AugmentedSubmittable<
        (
