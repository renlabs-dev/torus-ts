...
declare module "@polkadot/api-base/types/storage" {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    emission0: {
      consensusMembers: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Option<PalletEmission0ConsensusMember>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      emissionRecyclingPercentage: AugmentedQuery<
        ApiType,
        () => Observable<Percent>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      incentivesRatio: AugmentedQuery<ApiType, () => Observable<Percent>, []> &
        QueryableStorageEntry<ApiType, []>;
      maxAllowedWeights: AugmentedQuery<ApiType, () => Observable<u16>, []> &
        QueryableStorageEntry<ApiType, []>;
      minAllowedWeights: AugmentedQuery<ApiType, () => Observable<u16>, []> &
        QueryableStorageEntry<ApiType, []>;
      minStakePerWeight: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      pendingEmission: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      weightControlDelegation: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array,
    ...
    governance: {
      agentApplications: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array,
        ) => Observable<Option<PalletGovernanceApplicationAgentApplication>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      allocators: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<Option<Null>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      curators: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<Option<Null>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      daoTreasuryAddress: AugmentedQuery<
        ApiType,
        () => Observable<AccountId32>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      globalGovernanceConfig: AugmentedQuery<
        ApiType,
        () => Observable<PalletGovernanceConfigGovernanceConfiguration>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      notDelegatingVotingPower: AugmentedQuery<
        ApiType,
      ...
      proposals: AugmentedQuery<
        ...
        ) => Observable<Option<PalletGovernanceProposal>>,
        [u64]
      > &
        QueryableStorageEntry<ApiType, [u64]>;
      treasuryEmissionFee: AugmentedQuery<
        ApiType,
        () => Observable<Percent>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      unrewardedProposals: AugmentedQuery<
        ApiType,
        (
          arg: u64 | AnyNumber | Uint8Array,
        ) => Observable<Option<PalletGovernanceProposalUnrewardedProposal>>,
        [u64]
      > &
        QueryableStorageEntry<ApiType, [u64]>;
    ...
    torus0: {
      agents: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Option<PalletTorus0Agent>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      burn: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      burnConfig: AugmentedQuery<
        ApiType,
        () => Observable<PalletTorus0BurnBurnConfiguration>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      dividendsParticipationWeight: AugmentedQuery<
        ApiType,
        () => Observable<Percent>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      feeConstraints: AugmentedQuery<
        ApiType,
        () => Observable<PalletTorus0FeeValidatorFeeConstraints>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      immunityPeriod: AugmentedQuery<ApiType, () => Observable<u16>, []> &
        QueryableStorageEntry<ApiType, []>;
      maxAgentUrlLength: AugmentedQuery<ApiType, () => Observable<u16>, []> &
        QueryableStorageEntry<ApiType, []>;
      maxAllowedAgents: AugmentedQuery<ApiType, () => Observable<u16>, []> &
        QueryableStorageEntry<ApiType, []>;
      maxAllowedValidators: AugmentedQuery<ApiType, () => Observable<u16>, []> &
        QueryableStorageEntry<ApiType, []>;
      ...
      > &
        QueryableStorageEntry<ApiType, []>;
      minAllowedStake: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      minNameLength: AugmentedQuery<ApiType, () => Observable<u16>, []> &
        QueryableStorageEntry<ApiType, []>;
      minValidatorStake: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      ...
      > &
        QueryableStorageEntry<ApiType, []>;
      rewardInterval: AugmentedQuery<ApiType, () => Observable<u16>, []> &
        QueryableStorageEntry<ApiType, []>;
      stakedBy: AugmentedQuery<
        ApiType,
        (
          arg1: AccountId32 | string | Uint8Array,
      ...
      > &
        QueryableStorageEntry<ApiType, [AccountId32, AccountId32]>;
      totalStake: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
