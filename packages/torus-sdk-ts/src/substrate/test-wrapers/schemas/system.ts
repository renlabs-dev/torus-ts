...
export { sb_address, sb_blocks, sb_bool, sb_h256, sb_number_int, sb_string };
...
export type SpWeightsWeightV2Weight = z.infer<
  typeof SP_WEIGHTS_WEIGHT_V2_SCHEMA
>;

// FrameSupportDispatchDispatchClass enum - based on types-lookup.ts line 123-129
export const FRAME_SUPPORT_DISPATCH_DISPATCH_CLASS_SCHEMA = sb_basic_enum([
  "Normal",
  "Operational",
  "Mandatory",
] as const);

export type FrameSupportDispatchDispatchClass = z.infer<
  typeof FRAME_SUPPORT_DISPATCH_DISPATCH_CLASS_SCHEMA
>;

// FrameSupportDispatchPays enum - based on types-lookup.ts line 131-136
export const FRAME_SUPPORT_DISPATCH_PAYS_SCHEMA = sb_basic_enum([
  "Yes",
  "No",
] as const);

export type FrameSupportDispatchPays = z.infer<
  typeof FRAME_SUPPORT_DISPATCH_PAYS_SCHEMA
>;
...
export type FrameSupportDispatchDispatchInfo = z.infer<
  typeof FRAME_SUPPORT_DISPATCH_DISPATCH_INFO_SCHEMA
>;

// Use the shared substrate type schema for all complex types
export const SP_RUNTIME_DIGEST_SCHEMA = sb_substrate_type;
export const FRAME_SUPPORT_DISPATCH_PER_DISPATCH_CLASS_WEIGHT_SCHEMA =
  sb_substrate_type;
