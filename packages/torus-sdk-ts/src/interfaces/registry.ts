...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    PalletPermission0PermissionEmissionDistributionReason: PalletPermission0PermissionEmissionDistributionReason;
